...
if __name__ == "__main__":
    ...
    project_root = r"C:\Users\Yul\PycharmProjects\PitcherKinetiX\data\val"

    video_input_dir = os.path.join(project_root, "val_video_data")
    cropped_output_dir = os.path.join(project_root, "val_cropped_videos")
    json_output_dir = os.path.join(project_root, "val_json_2d")
    vis_output_dir = os.path.join(project_root, "val_check_2d")
